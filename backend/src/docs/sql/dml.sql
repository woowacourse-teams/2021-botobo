...
-- 문제집 생성
INSERT INTO workbook (name, user_id, opened, deleted, created_at, updated_at) VALUES ('데이터베이스', 1, false, false, now(), now());
INSERT INTO workbook (name, user_id, opened, deleted, created_at, updated_at) VALUES ('자바', 1, false, false   , now(), now());
INSERT INTO workbook (name, user_id, opened, deleted, created_at, updated_at) VALUES ('자바스크립트', 1, false, false, now(), now());
INSERT INTO workbook (name, user_id, opened, deleted, created_at, updated_at) VALUES ('네트워크', 1, false, false, now(), now());
INSERT INTO workbook (name, user_id, opened, deleted, created_at, updated_at) VALUES ('리액트', 1, false, false, now(), now());
INSERT INTO workbook (name, user_id, opened, deleted, created_at, updated_at) VALUES ('스프링', 1, false, false, now(), now());
